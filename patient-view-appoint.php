...
<link type="text/css" rel="stylesheet" href="patient-view-appoint.css">
...
<div class="container-fluid menu">
 ...
 <li class="dropdown"><a class="dropdown-toggle active" data-toggle="dropdown"  href="" >Appointments
	    <b class="caret"></b>
	    </a>
        ...
        <div class="panel">
            <div class="panel-heading ">
             ...
             <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				 <h1 class="panel-title text-center"><b>View Appointment</b>  </h1>
              </div>
